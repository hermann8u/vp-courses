...
- [symfony/symfony/webpack-encore-bundle](https://packagist.org/packages/symfony/webpack-encore-bundle) : Intégration de **Webpack** pour la gestion des assets avec une simplification de la syntaxe de configuration.
...
- [white-october/pagerfanta-bundle](https://packagist.org/packages/white-october/pagerfanta-bundle) : Fournit différents outils pour gérer la pagination.
...
- [easycorp/easyadmin-bundle](https://packagist.org/packages/) : Génération de tout un back-office en se basant sur vos entités Doctrine.
...
- [liip/imagine-bundle](https://packagist.org/packages/) : Redimensionnement et mis en cache d'image pour l'affichage.